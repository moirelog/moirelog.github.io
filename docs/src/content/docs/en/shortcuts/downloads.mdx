...
Shortcuts will be iterated irregularly to fix bugs and add new features. It is recommended to download and replace the old Shortcuts every once in a while to get the best experience.
...
Current Version: **v1.0.1** (2026-02-15)
...
To avoid frequent automatic updates, for example, modifying notes in folders other than Moire on your phone, the shortcut will skip changes with a time difference of more than 5 minutes.
:::
